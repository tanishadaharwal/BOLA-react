...
export default function MessageGSBola() {
  return (
    <Reveal>
      ...
      <div className=''>
      <img loading="lazy"  className="rounded-full lg:ml-10 ml-14 lg:w-80 lg:h-80 w-60 h-60 object-cover hover:scale-110 duration-300 mt-8" alt="GS-BOLA"src={require('../ClubLogos/coreTeam/Swaran.jpg')}></img>
