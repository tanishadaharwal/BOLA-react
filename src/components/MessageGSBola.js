...
export default function MessageGSBola() {
  return (
    <div className='px-36 pt-36 h-screen '>
      <h1 className='text-4xl text-[#f9c23c] font-bold mb-6'>Message from GS Bola</h1>
      ...
      <div>
      <img className="  rounded-xl  w-72 h-80 hover:scale-110 duration-300 mt-8" alt="GS-BOLA"src="GS_BOLA.jpg"></img>
      <h2 className='text-lg mt-3 text-center mx-auto text-white'>Mr. Swaran Pratap Singh</h2>
      </div>
