...
<div className=' '><img loading="lazy"  className='lg:h-96 lg:w-96 h-36 w-36 border-2 border-white rounded-2xl p-2' alt="club-log" src={DebSocLogo}></img></div>
    <div className=' '><img loading="lazy"  className='lg:h-96 lg:w-96 h-36 w-36 border-2 border-white rounded-2xl p-2' alt="club-log"src={DebSocLogo}></img></div>
    <div className=' '><img loading="lazy"  className='lg:h-96 lg:w-96 h-36 w-36 border-2 border-white rounded-2xl p-2' alt="club-log"src={DebSocLogo}></img></div>
    <div className=' '><img loading="lazy"  className='lg:h-96 lg:w-96 h-36 w-36 border-2 border-white rounded-2xl p-2' alt="club-log"src={DebSocLogo}></img></div>
    <div className=''><img loading="lazy"  className='lg:h-96 lg:w-96 h-36 w-36 border-2 border-white rounded-2xl p-2' alt="club-log"src={DebSocLogo}></img></div>
    ...
    <div className='ml:mx-36 mx-5 '>
      ...
      >
          ...
          <MemberCard name="Ishaan Sharma" number="56453413345" position="Co-ordinator" image="Ishaan.jpg"/>
             
          <MemberCard name="Rhea Sanjay" number="56453413345" position="Co-ordinator" image="Rhea Sanjay.jpg"/>
          <MemberCard name="Shreyas Manak" number="56453413345" position="Co-ordinator" image="Shreyas.jpg"/>
      ...
      {selectedYear === '2022-2023' && (
       ...
       >
         <div className='mt-10 flex space-y-5 px-1 lg:px-20  flex-col'>
          ...
          <MemberCard name="Umang Raj" number="56453413345" position="Co-ordinator" image="Umang.jpg"/>
            
          <MemberCard name="Aditya Sahu" number="56453413345" position="Co-ordinator" image="Aditya_.jpg"/>
