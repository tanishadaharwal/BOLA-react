...
export default function MessageGSBola() {
  return (
    <div className='mx-36 mt-32 '>
      <h1 className='text-4xl font-bold mb-6'>Message from GS Bola</h1>
      <h2 className='text-xl'>Mr. Swaran Pratap Singh</h2>
      ...
      <img className=" rounded-2xl w-56 hover:scale-105 duration-300 mt-8" alt="GS-BOLA"src="GS_BOLA.jpg"></img>
      </div>
