...
export default function MessageFA() {
  return (
            ...
            <div>
            <img loading="lazy"  className=" rounded-xl mx-auto lg:w-72 lg:h-80 w-40 h-72  hover:scale-110 duration-300 mt-8" alt="FA"src="FA.jpg"></img>
              <h4 className='text-lg mt-3 text-center mx-auto text-[#ebecf3]'>Dr. Aparna Nandha</h4>
            </div>
            
              <div className='mt-8 h-1/2 lg:w-[70%] lg:text-xl text-sm text-[#ebecf3] pr-4 font-semibold text-left  leading-10'>
